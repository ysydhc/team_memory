...
class TestTmTaskUpdateGroupCompleted:
    ...
    # NOTE: test_update_completed_with_changed_files_writes_architecture_bindings
    # and test_update_completed_empty_changed_files_git_auto_parse were removed
    # because replace_architecture_bindings was dropped in
    # c0c8c69 (chore: remove GitNexus and architecture node binding).
